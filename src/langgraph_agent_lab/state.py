...
class AgentState(TypedDict, total=False):
    ...
    Scalar fields are overwritten by returning a partial dict.
    List fields with Annotated[list[...], add] are append-only via reducer.
    """
    ...
    # Reducer append-only collections
